...
public class GuiHelper {
    ...
    public static void drawTexturedRectangle(BufferBuilder buffer, double x0, double y0, double x1, double y1, double z, double u0, double v0, double u1, double v1, int r, int g, int b, int a) {
